        ...
        body: SafeArea(
            child: BlocListener<AuthenticationBloc, AuthenticationState>(
                ...
                listener: (context, state) {
                  if(state is AuthSuccess) const App().setNavigation(context, AppRoutes.name);
...
class SignupPageLarge extends StatelessWidget {
  const SignupPageLarge({Key? key}) : super(key: key);
